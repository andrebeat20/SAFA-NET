          ...
          >
            <div className="flex justify-between items-center mb-8">
              ...
              <button 
                ...
                className="w-12 h-12 flex items-center justify-center bg-slate-100 dark:bg-slate-800 rounded-2xl text-slate-500 hover:bg-slate-200 dark:hover:bg-slate-700 disabled:opacity-50 transition-colors cursor-pointer"
              >
                <X className="w-6 h-6" />
              </button>
            </div>
              ...
              {paymentMethods.map((method) => {
                ...
                return (
                  <button
                    ...
                    disabled={isSubmitting || isSuccess}
                    className={`w-full flex items-center p-5 rounded-[24px] transition-all text-left border-2 duration-300 cursor-pointer ${
                      isSelected 
            ...
            <button
              ...
              disabled={isSubmitting || isSuccess}
              className={`w-full h-18 flex items-center justify-center rounded-[24px] text-[16px] font-black uppercase tracking-[0.2em] transition-all shadow-2xl active:scale-[0.98] cursor-pointer ${
                isSuccess 
